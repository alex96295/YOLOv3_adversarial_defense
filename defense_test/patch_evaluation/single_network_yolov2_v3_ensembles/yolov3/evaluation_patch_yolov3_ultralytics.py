...
clean_results = bb.io.load('det_coco', './json_files/clean_results_ultralytics.json', class_label_map={0: 'person'})
patch_results_obj = bb.io.load('det_coco', './json_files/yolov3_patches/proper_patched_obj_ultralytics.json', class_label_map={0: 'person'})
...
plt.savefig('./pr-curves/single_patches_vs_single_network/yolov3_patch/yolov3_patch_ultralytics.eps')
plt.savefig('./pr-curves/single_patches_vs_single_network/yolov3_patch/yolov3_patch_ultralytics.png')
