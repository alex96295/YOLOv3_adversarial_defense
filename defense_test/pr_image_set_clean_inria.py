...
shared_path = './def_test_img_folder_inria/rows05_batch/rows_factor05/pr_curves_tot/clean/'
json_files_pos_path = shared_path + 'json_files_ablr05/'
gtpath = shared_path + 'gt_labels/'

map_savepath = './def_test_img_folder/map_saved/'
...
ax.set_title('PR curves according to position\nNET: yolov3_tr_rows05, ABLATION: rows, RF=0.5, DATASET: INRIA')
...
plt.savefig(os.path.join(shared_path, "pr_yv3r05_ablrow05.png"))
...
############################################################################################################
''' save map values '''
txt_name = 'map_yv3_r05ablr05.txt'
