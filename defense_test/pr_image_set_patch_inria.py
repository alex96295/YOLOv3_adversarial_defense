...
shared_path = './def_test_img_folder_inria/rows05_batch/rows_factor05/pr_curves_tot/patch/'
...
ax.set_title('PR curves according to position\n NET: yolov3_tr_rows05, ABLATION: rows, RF=0.5, DATASET: INRIA patched')
