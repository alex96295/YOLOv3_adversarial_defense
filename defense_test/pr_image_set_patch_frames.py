...
shared_path = './def_test_img_folder/rows05_batch100/clean_factor1/pr_curves_tot/patch/'
json_files_pos_path = './def_test_img_folder/rows05_batch100/clean_factor1/pr_curves_tot/patch/json_files_ablr05/'
gtpath = shared_path + 'gt_labels/'
map_savepath = './def_test_img_folder/map_saved/rows05_batch100/clean_factor1/'
...
ax.set_title('PR curves according to position\n NET: yolov3_tr_baseline, ABLATION: rows, RF=0.5, DATASET: video frames patched')
...
plt.savefig(os.path.join(shared_path, "pr_yv3b1_ablrow05.png"))
