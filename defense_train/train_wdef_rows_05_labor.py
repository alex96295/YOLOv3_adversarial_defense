...
last = wdir + 'last_wdef_rows_05_30_labor_true.pt'
best = wdir + 'best_wdef_rows_05_30_labor_true.pt'
results_file = 'results_wdef_rows_05_30_labor_true.txt'
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.ablation:
                ...
                targets = gt_ablation_complete_q.labels_ablation(targets, imgs_h, imgs_w, ni, retain_size_col, retain_size_rows, device)
