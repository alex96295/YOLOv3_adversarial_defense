...
import test_wdef_column_0125  # import test.py to get mAP after each epoch
...
last = wdir + 'last_wdef_column_0125_30.pt'
best = wdir + 'best_wdef_column_0125_30.pt'
results_file = 'results_wdef_column_0125_30.txt'
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.ablation:
                ...
                imgs, _ = random_mask_batch_one_sample(imgs, ni, retain_size, device, reuse_noise = True)
                ...
                targets = gt_ablation.labels_ablation(targets, imgs_h, imgs_w, ni, retain_size, device)
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            ...
            results, maps = test_wdef_column_0125.test(cfg,
                                      data,
                                      batch_size=batch_size,
                                      imgsz=imgsz_test,
                                      model=ema.ema,
