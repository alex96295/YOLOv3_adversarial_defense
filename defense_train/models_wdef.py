...
def create_modules(module_defs, img_size, cfg, defense=False):
    ...
    if defense:
        print('Input channels = 6')
        output_filters = [6] #[3]  # input channels
    else:
        output_filters = [3]
...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, img_size=(416, 416), verbose=False):
        ...
        print('Darknet correct')

        self.module_defs = parse_model_cfg(cfg)
        self.module_list, self.routs = create_modules(self.module_defs, img_size, cfg, defense=True)
