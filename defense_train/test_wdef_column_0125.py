...
def test(cfg,
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        if ablation:
            ...
            retain_size = int(0.125*imgs_w+0.5)
            #print(block_size)
            imgs, _ = random_mask_batch_one_sample(imgs, batch_i, retain_size, device, reuse_noise = True)
            ...
            targets = gt_ablation.labels_ablation(targets, imgs_h, imgs_w, batch_i, retain_size, device)
