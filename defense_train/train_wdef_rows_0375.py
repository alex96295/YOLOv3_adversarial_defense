...
import test_wdef_rows_0375  # import test.py to get mAP after each epoch
...
last = wdir + 'last_wdef_rows_0375_100_correct.pt'
best = wdir + 'best_wdef_rows_0375_100_correct.pt'
results_file = 'results_wdef_rows_0375_100_correct.txt'
...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            ...
            results, maps = test_wdef_rows_0375.test(cfg,
                                      data,
                                      batch_size=batch_size,
                                      imgsz=imgsz_test,
                                      model=ema.ema,
