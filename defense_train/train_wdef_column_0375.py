...
import test_wdef_column_0375  # import test.py to get mAP after each epoch
...
last = wdir + 'last_wdef_column_0375_30nobreak.pt'
best = wdir + 'best_wdef_column_0375_30nobreak.pt'
results_file = 'results_wdef_column_0375_30nobreak.txt'
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if opt.ablation:
                ...
                imgs, _ = random_mask_batch_one_sample(imgs, ni, retain_size_col, device, reuse_noise = True)
                ...
                targets = gt_labels_no_loop_export_col.labels_ablation(targets, imgs_h, imgs_w, ni, retain_size_col, retain_size_rows, device)

            print(str(imgs.size()) + '\n')    
            
            #imgs_show = transforms.ToPILImage('RGB')(single_abl[0].cpu())    
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            ...
            results, maps = test_wdef_column_0375.test(cfg,
                                      data,
                                      batch_size=batch_size,
                                      imgsz=imgsz_test,
                                      model=ema.ema,
