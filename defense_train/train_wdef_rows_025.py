...
import test_wdef_rows_025  # import test.py to get mAP after each epoch
...
last = wdir + 'last_wdef_rows_025_30.pt'
best = wdir + 'best_wdef_rows_025_30.pt'
results_file = 'results_wdef_rows_025_30.txt'
...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            ...
            results, maps = test_wdef_rows_025.test(cfg,
                                      data,
                                      batch_size=batch_size,
                                      imgsz=imgsz_test,
                                      model=ema.ema,
